...
import controller.DAO.SecureRandomTagGen;
	...
	public AddNewProductItem() {
		...
		gl_contentPanel.setHorizontalGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPanel.createSequentialGroup().addGap(43)
						.addComponent(addTitleField, GroupLayout.DEFAULT_SIZE, 317, Short.MAX_VALUE).addGap(62))
		...
		gl_contentPanel.setVerticalGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPanel.createSequentialGroup()
						...
						.addGap(13).addComponent(inputDetailsPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)));
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				addButton.addActionListener(new ActionListener() {
					...
					public void addProductDetailInDB() {
						...
						boolean status = true;
						int id = 0; // id is auto-incremented
						...
						tmpProduct = new Product(id, productTagNum, productName, productBrand, cprice, sprice, status);
